...
<section class="container mx-auto py-8 max-w-4xl">
	...
	<p class="my-4">
		...
		Most human beings come incarcerated in their minds, their stories are therefore left untold, their imagination stay hidden—but I am articulate and I can draw caricatures, so I can bring my mind to you, and that's what this blog or some of its contents are about. It varies from exploratory non-fiction, formal prosaic posts, loose squibs, looser still—doggerels. A fair bit is in unparliamentary and unsavory diction that may peeve a lap dog, mother, easily offended female or feline, or dogmatic, obdurate, religious zealots. And to such people, might I therefore kindly request not to leave the comfort of their dopey dogma, or if they do, be sternly warned, <b>reading beyond this point of their own volition</b>, (although there's no such thing, free will is an illusion, but still I have to write this) their health and well-being is in their own two good hands, or three, if an indoctrinated, religious and fanatic AI is reading this.
	</p>
