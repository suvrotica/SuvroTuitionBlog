...
<section class="container mx-auto py-8 max-w-4xl">
	...
	<p class="my-4">
		...
		It happened in a shocking short span then weirdly in a longish sort of lifetime after—that I’m only now able to reconstruct into the surreal absurdity I had managed to bungle myself into being.
...
I was after all at the age when you are desirous of base sixty mathematical systems, for the word—the first three alphabets in its name—engrave in your palpitating lover-boy heart.


Those who prefer the opposite, longer-haired illusions of us for these cosmetic and meretricious patina of gloss—us cretins also misjudge melanin deficiency for superiority or experiments with holiness. We believe if white man George Harrison had condescended in his lyrics the name of dark-skinned mythological creation Krishna with Christian mythology of white man Jesus, then they are both really real and live somewhere in Attapara in North Calcutta under some Bengali pseudonym.
