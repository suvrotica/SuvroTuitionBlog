...
$$ \vec{v}_{n-1} = \begin{bmatrix} f_{n-1} \\ f_{n-2} \end{bmatrix} $$
...
$$ \vec{v}_{n} = \begin{bmatrix} f_n \\ f_{n-1} \end{bmatrix} $$
...
$$ \begin{bmatrix} a & b \\ c & d \end{bmatrix} \begin{bmatrix} f_{n-1} \\ f_{n-2} \end{bmatrix} = \begin{bmatrix} f_n \\ f_{n-1} \end{bmatrix} $$
