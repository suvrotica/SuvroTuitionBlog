...
If I take this rule—that Kolkata doubles its population every 50 years—and run with it, what happens over the next five centuries? A 500-year projection means we’ll have 10 doubling periods ($500 / 50 = 10$). The formula is my city’s current population multiplied by 2, ten times over:
