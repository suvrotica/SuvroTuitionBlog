...
So when the line says *“the pedagogical cost is real,”* it means: there’s a real downside in teaching and learning when we use ordinary words like “field” for highly abstract concepts. Students can get misled by the wrong imagery, and it takes extra work to shake off that baggage once the subject grows more advanced.
