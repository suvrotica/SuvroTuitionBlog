...
So: French usage, mid-1800s in the Cauchy–Jordan neighborhood; English usage, commonplace only by the mid-twentieth century, once the subject congeals around vector spaces, transformations, and matrices and finally gets the name it had been quietly earning for a century.
