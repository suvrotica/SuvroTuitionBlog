...
<script>
    ...
    import imageSrc from '$lib/assets/slideshow-images/portrait/Gemini_Generated_Image_4m6pdy4m6pdy4m6p.png?url';
    
</script>

<PostImage src={imageSrc} alt="H1b person" />
<PostBadge
	title="Not Ambition"
...
So here it is, etched forever:
**Suvro’s Law: In the age of superintelligent AI, human employment correlates inversely with competence, and directly with cosmetics and compliance.**
