...
<script>
   import PostBadge from '$lib/components/ui/PostBadge.svelte';
    ...
    import imageSrc1 from '$lib/assets/slideshow-images/portrait/IMG-20250329-WA0000.jpg?url';
    
</script>

<PostImage src={imageSrc1} alt="looking at porn" />

<br>
Candle is not too hot to handle,<br>
...
A north Calcutta fuck-face gasping.<br>
...
Bamboozling city of pimps and hoe.<br>
