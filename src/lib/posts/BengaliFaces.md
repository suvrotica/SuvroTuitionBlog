...
tags: ["Faces", "Obese", "Kolkata", "Calcutta", "Fat", "Sphere", "tits", "Buttocks"]
...
$\text{Facial Roundness Index (FRI)} = \frac{4\pi \times \text{Facial Area}}{\text{Perimeter}^2}$

An FRI approaching $1$ is a face absurdly round, painfully perfect—a geometry only an accountant or an actuary could love. Biology shrugs—“I was aiming for Fibonacci spirals and got pi instead. Sue me.”
